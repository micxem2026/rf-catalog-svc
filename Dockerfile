...
ENTRYPOINT ["java","-XX:+UseContainerSupport","-XX:+UseG1GC","-XX:ParallelGCThreads=2","-XX:ConcGCThreads=1","-Xms128m","-Xmx384m","-XX:MaxMetaspaceSize=256m","-jar","/rf-catalog-svc.jar"]